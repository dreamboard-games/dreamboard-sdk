...
import { CardFace, type ViewCard } from "@dreamboard-games/ui-sdk";
import {
  MobileHandTrayProvider,
  useRegisterMobileHand,
  type HandRole,
} from "@dreamboard-games/ui-sdk/components";
import { ToastProvider, useIsMobile } from "@dreamboard-games/ui-sdk";
import {
  createDreamboardUI,
  type DreamboardUI,
  type TypedGame,
...
export type { BoardSpaceTargetProps } from "./primitives/index.js";
export type { HandRole } from "@dreamboard-games/ui-sdk/components";
