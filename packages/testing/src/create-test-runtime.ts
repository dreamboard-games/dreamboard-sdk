...
import type {
  ...
  PluginStateSnapshot,
  ZoneHandlesSnapshot,
} from "@dreamboard-games/ui-runtime/reducer";
import type {
  RuntimeAPI,
  SubmissionError,
  ValidationResult,
} from "@dreamboard-games/ui-runtime/types/runtime-api";
import type { PluginSessionState as RuntimePluginSessionState } from "@dreamboard-games/ui-runtime/types/runtime-api";
