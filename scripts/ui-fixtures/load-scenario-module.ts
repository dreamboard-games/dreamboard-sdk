...
import { referenceGamesRoot, root } from "../ui/support.ts";
...
export interface LoadedScenario extends DynamicRecord {
  readonly id: string;
  readonly __modulePath: string;
  readonly gameId?: string;
}

async function importScenarioModule(
  absolutePath: string,
...
function assertObject(
  value: unknown,
  message: string,
): asserts value is DynamicRecord {
...
function validateScenarioDefinition(
  scenario: unknown,
  modulePath: string,
): asserts scenario is DynamicRecord & { id: string } {
