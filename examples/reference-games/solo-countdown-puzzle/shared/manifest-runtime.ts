...
export const BeaconGridBoardFieldsSchema = z.record(z.string(), z.unknown());

export type BeaconGridSpaceFields = RuntimeRecord;

export const BeaconGridSpaceFieldsSchema = z.record(z.string(), z.unknown());

export type BeaconGridRelationFields = RuntimeRecord;

export const BeaconGridRelationFieldsSchema = z.record(z.string(), z.unknown());
...
export const BeaconGridEdgeFieldsSchema = z.record(z.string(), z.unknown());

export type BeaconGridVertexFields = RuntimeRecord;

export const BeaconGridVertexFieldsSchema = z.record(z.string(), z.unknown());

export type BoardFieldsByBoardId = {
  "beacon-grid": BeaconGridBoardFields;
};

export type BoardSpaceFieldsByBoardId = {
  "beacon-grid": BeaconGridSpaceFields;
};

export type BoardRelationFieldsByBoardId = {
  "beacon-grid": BeaconGridRelationFields;
};

export type BoardContainerFieldsByBoardId = {
  "beacon-grid": BeaconGridContainerFields;
};
...
export type SquareEdgeFieldsByBoardId = {
  "beacon-grid": BeaconGridEdgeFields;
};

export type SquareVertexFieldsByBoardId = {
  "beacon-grid": BeaconGridVertexFields;
};
...
export type SquareBoardStateById = {
  "beacon-grid": BoardStateById["beacon-grid"];
};
...
const boardStateByIdSchema = z.object({
  "beacon-grid": z.object({
    id: z.literal("beacon-grid"),
    baseId: z.literal("beacon-grid"),
    layout: z.literal("square"),
    typeId: z.literal("beacon-grid"),
    scope: z.literal("shared"),
    playerId: ids.playerId.nullable().optional(),
    templateId: z.string().nullable().optional(),
    fields: BeaconGridBoardFieldsSchema,
    ...
    spaces: z.record(
      ...
      z.object({
        ...
        row: z.number().int(),
        col: z.number().int(),
        fields: BeaconGridSpaceFieldsSchema,
    ...
    relations: z.array(
      z.object({
        ...
        directed: z.boolean(),
        fields: BeaconGridRelationFieldsSchema,
      }),
    ),
    containers: z.object({}),
    edges: z.array(
      z.object({
        ...
        fields: BeaconGridEdgeFieldsSchema,
      }),
    ),
    vertices: z.array(
      z.object({
        ...
        label: z.string().nullable().optional(),
        ownerId: ids.playerId.nullable().optional(),
        fields: BeaconGridVertexFieldsSchema,
      }),
    ),
  }),
});
