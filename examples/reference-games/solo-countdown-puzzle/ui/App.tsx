      ...
      {view.beacons.map((beacon) => {
        const content = (
          <span className="flex w-full items-center justify-between gap-3">
            <span className="text-left">
              ...
              <span className="last-light-beacon-status text-xs">
        ...
        if (beaconGrid) {
          return (
            <beaconGrid.Space
              ...
              className="last-light-beacon min-h-20 rounded-xl border-2 p-3 transition"
            >
              {content}
            </beaconGrid.Space>
          );
        ...
        return (
          <button
            ...
            className="last-light-beacon min-h-20 rounded-xl border-2 p-3"
          >
            {content}
          </button>
        );
      ...
      <div className="last-light-layout mx-auto grid max-w-6xl gap-4">
        ...
        <aside className="space-y-4">
          ...
          <section aria-labelledby="history-heading" className={panelClass}>
            ...
            <ol
              className="mt-3 max-h-96 space-y-3 overflow-auto focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300"
              tabIndex={0}
              aria-live="polite"
            >
