...
export type CardIdsBySharedZoneId = {
  "apprentice-deck": Array<ApprenticeCardsCardId>;
  "apprentice-discard": Array<ApprenticeCardsCardId>;
  "order-deck": Array<OrderCardsCardId>;
  "order-discard": Array<OrderCardsCardId>;
};
export type CardIdsByPlayerZoneId = {
  "apprentice-hand": PerPlayer<Array<ApprenticeCardsCardId>>;
  "apprentice-tableau": PerPlayer<Array<ApprenticeCardsCardId>>;
  "order-hand": PerPlayer<Array<OrderCardsCardId>>;
};
