...
export const SurveyGridRelationFieldsSchema = z.record(z.string(), z.unknown());
...
export const SurveyGridEdgeFieldsSchema = z.record(z.string(), z.unknown());

export type SurveyGridVertexFields = RuntimeRecord;

export const SurveyGridVertexFieldsSchema = z.record(z.string(), z.unknown());

export type SurveyDieDieFields = RuntimeRecord;

export const SurveyDieDieFieldsSchema = z.record(z.string(), z.unknown());
...
export type SquareBoardStateById = {
  "survey-grid:player-1": BoardStateById["survey-grid:player-1"];
  "survey-grid:player-2": BoardStateById["survey-grid:player-2"];
  "survey-grid:player-3": BoardStateById["survey-grid:player-3"];
  "survey-grid:player-4": BoardStateById["survey-grid:player-4"];
};
...
const boardStateByIdSchema = z.object({
  "survey-grid:player-1": z.object({
    id: z.literal("survey-grid:player-1"),
    baseId: z.literal("survey-grid"),
    ...
    fields: SurveyGridBoardFieldsSchema,
    ...
    spaces: z.record(
      ...
      z.object({
        ...
        row: z.number().int(),
        col: z.number().int(),
        fields: SurveyGridSpaceFieldsSchema,
    ...
    relations: z.array(
      z.object({
        ...
        directed: z.boolean(),
        fields: SurveyGridRelationFieldsSchema,
      }),
    ),
    containers: z.object({}),
    edges: z.array(
      z.object({
        ...
        fields: SurveyGridEdgeFieldsSchema,
      }),
    ),
    vertices: z.array(
      z.object({
        ...
        label: z.string().nullable().optional(),
        ownerId: ids.playerId.nullable().optional(),
        fields: SurveyGridVertexFieldsSchema,
      }),
    ),
  }),
  "survey-grid:player-2": z.object({
    id: z.literal("survey-grid:player-2"),
    baseId: z.literal("survey-grid"),
    layout: z.literal("square"),
    typeId: ids.boardTypeId.nullable().optional(),
    scope: z.literal("perPlayer"),
  ...
  "survey-grid:player-3": z.object({
    id: z.literal("survey-grid:player-3"),
    baseId: z.literal("survey-grid"),
    layout: z.literal("square"),
    typeId: ids.boardTypeId.nullable().optional(),
    scope: z.literal("perPlayer"),
    playerId: z.literal("player-3"),
    templateId: z.string().nullable().optional(),
    fields: SurveyGridBoardFieldsSchema,
    // T220: see generic-board comment on the loose-keying choice.
    spaces: z.record(
  ...
  "survey-grid:player-4": z.object({
    id: z.literal("survey-grid:player-4"),
    baseId: z.literal("survey-grid"),
    layout: z.literal("square"),
    typeId: ids.boardTypeId.nullable().optional(),
    scope: z.literal("perPlayer"),
    playerId: z.literal("player-4"),
    templateId: z.string().nullable().optional(),
    fields: SurveyGridBoardFieldsSchema,
    // T220: see generic-board comment on the loose-keying choice.
    spaces: z.record(
...
const boardLayoutByIdLookup = {
  "survey-grid:player-1": "square",
  "survey-grid:player-2": "square",
  "survey-grid:player-3": "square",
  "survey-grid:player-4": "square",
} as const;
...
const spaceTypeIdByBoardIdLookup = {
  "survey-grid:player-1": {
    ...
    "cell-0-1": "survey-cell",
    "cell-0-2": "survey-cell",
    "cell-0-3": "survey-cell",
    "cell-1-0": "survey-cell",
    "cell-1-1": "survey-cell",
    "cell-1-2": "survey-cell",
    "cell-1-3": "survey-cell",
    "cell-2-0": "survey-cell",
    "cell-2-1": "survey-cell",
    "cell-2-2": "survey-cell",
    "cell-2-3": "survey-cell",
...
const containerIdsByBoardIdLookup = {
  ...
  "survey-grid:player-2": [] as const,
  "survey-grid:player-3": [] as const,
  "survey-grid:player-4": [] as const,
} as const;
...
const relationTypeIdsByBoardIdLookup = {
  ...
  "survey-grid:player-2": ["adjacent"] as const,
