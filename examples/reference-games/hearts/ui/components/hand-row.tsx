...
import type { HandSurface } from "../../shared/generated/ui-contract.ts";
import {
  cardLabel,
  comparePlayingCards,
      ...
      >
        ...
        <handSurface.Cards>
          {(card, state) => {
            ...
            // pop out of the row, and mute the cards that cannot be played right
            // now. During the playing phase the engine keeps every held card
            ...
            const lift = state.selected
              ...
              : showEligible
                ...
                : muted
                  ? ""
                  : "hover:-translate-y-2";
            const dim = muted ? "opacity-45 saturate-[0.5]" : "";
            return (
              <handSurface.Card
                card={card}
