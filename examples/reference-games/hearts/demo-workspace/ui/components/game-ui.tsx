...
export function HeartsSurfaces({
  ...
  return (
    <main className="mx-auto flex min-h-[100dvh] w-full max-w-[min(1120px,calc(100vw-20px))] flex-col gap-3 p-3 pb-44 sm:gap-4 lg:grid lg:grid-cols-[minmax(0,1fr)_300px] lg:grid-rows-[auto_minmax(0,1fr)] lg:items-stretch lg:pb-3">
      {/* ── Header ─────────────────────────────────────────────────────── */}
