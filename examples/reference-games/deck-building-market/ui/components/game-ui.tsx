...
function CardStrip({
  ...
  if (cardIds.length === 0) {
    return <span className="text-xs italic text-stone-600">{empty}</span>;
  }
  return (
    ...
    <>
      <main className="min-h-screen bg-[#f2eadb] text-stone-900 [background-image:linear-gradient(rgba(120,113,108,.08)_1px,transparent_1px)] [background-size:100%_28px]">
        ...
        <div className="mx-auto grid max-w-7xl gap-4 px-3 py-4 lg:grid-cols-[230px_minmax(0,1fr)_250px]">
          <aside className="space-y-4" aria-label="Studio status">
          ...
          <aside className="space-y-4" aria-label="Artists and activity">
        ...
        <div className="sticky bottom-0 z-20 border-t-2 border-stone-800 bg-[#fffdf7]/95 px-3 py-3 backdrop-blur">
