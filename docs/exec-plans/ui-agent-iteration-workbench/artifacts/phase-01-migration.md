...
- Added internal repository lock:
  `<private-product-checkout>/examples/reference-bundle.lock.json`.
- Added internal repository materializer:
  `<private-product-checkout>/scripts/reference-games/materialize-reference-bundle.mjs`.
- The materializer verifies the bundle digest and extracts only to
  `<private-product-checkout>/build/reference-games/sdk-reference-games`.
...
pnpm pack:dry-run
pnpm format:check
node scripts/reference-games/materialize-reference-bundle.mjs --bundle <sdk-checkout>/build/reference-games/reference-games-bundle.tgz
```
