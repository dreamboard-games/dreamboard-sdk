...
| Stable visual compositions    | Storybook visual baselines                  |
...
Storybook owns committed visual baselines. Workbench screenshots are generated
evidence attached to behavior runs; they are not a second platform-specific
baseline authority.
